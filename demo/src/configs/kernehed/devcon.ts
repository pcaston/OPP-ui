...
export const demoDevconKernehed: DemoConfig["devcon"] = () => ({
  name: "Hem",
  resources: [
    // {
    //   url: "/local/custom-devcon/monster-card.js",
    //   type: "js",
    // },
    // {
    //   url: "/local/custom-devcon/mini-media-player-bundle.js?v=0.9.8",
    //   type: "module",
    // },
    // {
    //   url: "/local/custom-devcon/slideshow-card.js?=1.1.0",
    //   type: "js",
    // },
    // {
    //   url: "/local/custom-devcon/fold-entity-row.js?v=3ae2c4",
    //   type: "js",
    // },
    // {
    //   url: "/local/custom-devcon/swipe-card/swipe-card.js?v=2.0.0",
    //   type: "module",
    // },
    // {
    //   url: "/local/custom-devcon/upcoming-media-card/upcoming-media-card.js",
    //   type: "js",
    // },
    // {
    //   url: "/local/custom-devcon/tracker-card.js?v=0.1.5",
    //   type: "js",
    // },
    // {
    //   url: "/local/custom-devcon/card-tools.js?v=6ce5d0",
    //   type: "js",
    // },
    // {
    //   url: "/local/custom-devcon/krisinfo.js?=0.0.1",
    //   type: "js",
    // },
  ],
  views: [
