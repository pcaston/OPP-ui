...
export const mockTranslations = (opp: MockOpenPeerPower) => {
  opp.mockWS("frontend/get_translations", () => ({
    resources: {
      ...
      "component.homematicip_cloud.config.step.link.description":
        "Press the blue button on the access point and the submit button to register HomematicIP with Open Peer Power.\n\n![Location of button on bridge](/static/images/config_flows/config_homematicip_cloud.png)",
      ...
      "component.nest.config.abort.no_flows":
        "You need to configure Nest before being able to authenticate with it. [Please read the instructions](https://www.open-peer-power.io/integrations/nest/).",
      ...
      "component.mailgun.config.abort.not_internet_accessible":
        "Your Open Peer Power instance needs to be accessible from the internet to receive Mailgun messages.",
      ...
      "component.upnp.config.step.user.data.enable_port_mapping":
        "Enable port mapping for Open Peer Power",
      ...
      "component.point.config.abort.no_flows":
        "You need to configure Point before being able to authenticate with it. [Please read the instructions](https://www.open-peer-power.io/integrations/point/).",
      ...
      "component.auth.mfa_setup.totp.error.invalid_code":
        "Invalid code, please try again. If you get this error consistently, please make sure the clock of your Open Peer Power system is accurate.",
      ...
      "component.hue.config.step.link.description":
        "Press the button on the bridge to register Philips Hue with Open Peer Power.\n\n![Location of button on bridge](/static/images/config_philips_hue.jpg)",
      ...
      "component.mqtt.config.step.oppio_confirm.data.discovery":
        "Enable discovery",
      "component.mqtt.config.step.oppio_confirm.description":
        "Do you want to configure Open Peer Power to connect to the MQTT broker provided by the opp.io add-on {addon}?",
      "component.mqtt.config.step.oppio_confirm.title":
        "MQTT Broker via Opp.io add-on",
      "component.mqtt.config.title": "MQTT",
      "component.geofency.config.abort.not_internet_accessible":
        "Your Open Peer Power instance needs to be accessible from the internet to receive messages from Geofency.",
      "component.geofency.config.abort.one_instance_allowed":
        "Only a single instance is necessary.",
      "component.geofency.config.create_entry.default":
        "To send events to Open Peer Power, you will need to setup the webhook feature in Geofency.\n\nFill in the following info:\n\n- URL: `{webhook_url}`\n- Method: POST\n\nSee [the documentation]({docs_url}) for further details.",
      ...
      "component.dialogflow.config.abort.not_internet_accessible":
        "Your Open Peer Power instance needs to be accessible from the internet to receive Dialogflow messages.",
      "component.dialogflow.config.abort.one_instance_allowed":
        "Only a single instance is necessary.",
      "component.dialogflow.config.create_entry.default":
        "To send events to Open Peer Power, you will need to setup [webhook integration of Dialogflow]({dialogflow_url}).\n\nFill in the following info:\n\n- URL: `{webhook_url}`\n- Method: POST\n- Content Type: application/json\n\nSee [the documentation]({docs_url}) for further details.",
      ...
      "component.deconz.config.step.link.description":
        'Unlock your deCONZ gateway to register with Open Peer Power.\n\n1. Go to deCONZ system settings\n2. Press "Unlock Gateway" button',
      ...
      "component.locative.config.create_entry.default":
        "To send locations to Open Peer Power, you will need to setup the webhook feature in the Locative app.\n\nFill in the following info:\n\n- URL: `{webhook_url}`\n- Method: POST\n\nSee [the documentation]({docs_url}) for further details.",
      "component.ios.config.abort.single_instance_allowed":
        "Only a single configuration of Open Peer Power iOS is necessary.",
      "component.ios.config.step.confirm.description":
        "Do you want to set up the Open Peer Power iOS component?",
      "component.ios.config.step.confirm.title": "Open Peer Power iOS",
      "component.ios.config.title": "Open Peer Power iOS",
      ...
      "component.ifttt.config.abort.not_internet_accessible":
        "Your Open Peer Power instance needs to be accessible from the internet to receive IFTTT messages.",
      "component.ifttt.config.abort.one_instance_allowed":
        "Only a single instance is necessary.",
      "component.ifttt.config.create_entry.default":
        'To send events to Open Peer Power, you will need to use the "Make a web request" action from the [IFTTT Webhook applet]({applet_url}).\n\nFill in the following info:\n\n- URL: `{webhook_url}`\n- Method: POST\n- Content Type: application/json\n\nSee [the documentation]({docs_url}) on how to configure automations to handle incoming data.',
      ...
      "component.twilio.config.abort.not_internet_accessible":
        "Your Open Peer Power instance needs to be accessible from the internet to receive Twilio messages.",
      "component.twilio.config.abort.one_instance_allowed":
        "Only a single instance is necessary.",
      "component.twilio.config.create_entry.default":
        "To send events to Open Peer Power, you will need to setup [Webhooks with Twilio]({twilio_url}).\n\nFill in the following info:\n\n- URL: `{webhook_url}`\n- Method: POST\n- Content Type: application/x-www-form-urlencoded\n\nSee [the documentation]({docs_url}) on how to configure automations to handle incoming data.",
      ...
      "component.gpslogger.config.abort.not_internet_accessible":
        "Your Open Peer Power instance needs to be accessible from the internet to receive messages from GPSLogger.",
      "component.gpslogger.config.create_entry.default":
        "To send events to Open Peer Power, you will need to setup the webhook feature in GPSLogger.\n\nFill in the following info:\n\n- URL: `{webhook_url}`\n- Method: POST\n\nSee [the documentation]({docs_url}) for further details.",
      ...
      "component.zwave.config.step.user.description":
        "See https://www.open-peer-power.io/docs/z-wave/installation/ for information on the configuration variables",
