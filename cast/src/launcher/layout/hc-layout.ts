  ...
  protected render(): TemplateResult {
    return html`
      <op-card>
        <div class="layout">
          ...
          <div class="card-header">
            Open Peer Power Cast${this.subtitle ? ` – ${this.subtitle}` : ""}
            ${this.auth
              ? html`
                  <div class="subtitle">
                    <a href=${this.auth.data.oppUrl} target="_blank"
                      >${this.auth.data.oppUrl.substr(
                        this.auth.data.oppUrl.indexOf("//") + 2
                      )}</a
                    >
                    ${this.user
                      ? html`
      ...
      <div class="footer">
        ...
        <a
          href="https://github.com/open-peer-power/open-peer-power-polymer/issues"
          target="_blank"
          >Let us know!</a
        >
      </div>
