...
module.exports = {
  ...
  root: path.resolve(__dirname, "../opp_frontend"),
  static: path.resolve(__dirname, "../opp_frontend/static"),
  output: path.resolve(__dirname, "../opp_frontend/frontend_latest"),
  output_es5: path.resolve(__dirname, "../opp_frontend/frontend_es5"),
  ...
  oppio_root: path.resolve(__dirname, "../oppio/build"),
