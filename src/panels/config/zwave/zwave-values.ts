...
export class ZwaveValues extends LitElement {
      ...
      <div class="content">
        ...
        >
          <div class="device-picker">
            <paper-dropdown-menu
              .label=${this.opp.localize("ui.panel.config.zwave.common.value")}
              dynamic-align
              class="flex"
            >
              <paper-listbox
  ...
  private _computeCaption(item) {
    ...
    out += ` (${this.opp.localize("ui.panel.config.zwave.common.instance")}:`;
    out += ` ${item.value.instance},`;
    out += ` ${this.opp.localize("ui.panel.config.zwave.common.index")}:`;
