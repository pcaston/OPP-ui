...
import { opStyleDialog, opStyle } from "../../../../resources/styles";
import { OpenPeerPower } from "../../../../types";
// tslint:disable-next-line
import { PaperInputElement } from "@polymer/paper-input/paper-input";
import { AutomationConfig } from "../../../../data/automation";
// tslint:disable-next-line
import { PlaceholderValues } from "./op-thingtalk-placeholders";
...
class DialogThingtalk extends LitElement {
  ...
  private async _generate() {
    ...
    try {
      const result = await convertThingTalk(this.opp, this._value);
