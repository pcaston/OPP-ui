import { OpenPeerPower, GroupEntity } from "../../../types";
import {
  DevconConfig,
  DevconCardConfig,
  DevconViewConfig,
} from "../../../data/devcon";
import { OppEntity, OppEntities, OppConfig } from "../../../websocket/lib";
...
import { DevconRowConfig, WeblinkConfig } from "../entity-rows/types";
...
export const computeCards = (
  ...
  const cards: DevconCardConfig[] = [];

  // For entity card
  const entities: Array<string | DevconRowConfig> = [];
...
export const generateDefaultViewConfig = (
  ...
  const areaCards: DevconCardConfig[] = [];
...
export const generateDevconConfigFromOpp = async (opp: OpenPeerPower) => {
  ...
  return generateDevconConfigFromData(
    opp.config,
    areaEntries,
    deviceEntries,
    entityEntries,
...
export const generateDevconConfigFromData = async (
  config: OppConfig,
  areaEntries: AreaRegistryEntry[],
  deviceEntries: DeviceRegistryEntry[],
  entityEntries: EntityRegistryEntry[],
