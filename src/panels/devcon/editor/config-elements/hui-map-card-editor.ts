...
export class HuiMapCardEditor extends LitElement implements DevconCardEditor {
    ...
    return html`
      ...
      <div class="card-config">
        ...
        <div class="side-by-side">
          ...
          <paper-input
            .label="${this.opp.localize(
              "ui.panel.devcon.editor.card.map.default_zoom"
            )} (${this.opp.localize(
              "ui.panel.devcon.editor.card.config.optional"
            )})"
            type="number"
        ...
        <op-switch
          ...
          >${this.opp.localize(
            "ui.panel.devcon.editor.card.map.dark_mode"
          )}</op-switch
        >
        <hui-entity-editor
          .opp="${this.opp}"
        ...
        <h3>
          ${this.opp.localize(
            "ui.panel.devcon.editor.card.map.geo_location_sources"
          )}
        </h3>
        <div class="geo_location_sources">
          <hui-input-list-editor
            inputLabel=${this.opp.localize(
              "ui.panel.devcon.editor.card.map.source"
            )}
            .opp="${this.opp}"
