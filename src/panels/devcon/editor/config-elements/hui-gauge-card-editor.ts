...
export class HuiGaugeCardEditor extends LitElement implements DevconCardEditor {
    ...
    return html`
      ...
      <div class="card-config">
        ...
        <paper-input
          type="number"
          .label="${this.opp.localize(
            "ui.panel.devcon.editor.card.generic.minimum"
          )} (${this.opp.localize(
            "ui.panel.devcon.editor.card.config.optional"
          )})"
          .value="${this._min}"
        ...
        <paper-input
          type="number"
          .label="${this.opp.localize(
            "ui.panel.devcon.editor.card.generic.maximum"
          )} (${this.opp.localize(
            "ui.panel.devcon.editor.card.config.optional"
          )})"
          .value="${this._max}"
        ...
        <op-switch
          ...
          >${this.opp.localize(
            "ui.panel.devcon.editor.card.gauge.severity.define"
          )}</op-switch
        >
        ${this._config!.severity !== undefined
          ? html`
              <paper-input
                type="number"
                .label="${this.opp.localize(
                  "ui.panel.devcon.editor.card.gauge.severity.green"
                )} (${this.opp.localize(
              "ui.panel.devcon.editor.card.config.required"
            )})"
              ...
              <paper-input
                type="number"
                .label="${this.opp.localize(
                  "ui.panel.devcon.editor.card.gauge.severity.yellow"
                )} (${this.opp.localize(
              "ui.panel.devcon.editor.card.config.required"
            )})"
              ...
              <paper-input
                type="number"
                .label="${this.opp.localize(
                  "ui.panel.devcon.editor.card.gauge.severity.red"
                )} (${this.opp.localize(
              "ui.panel.devcon.editor.card.config.required"
            )})"
