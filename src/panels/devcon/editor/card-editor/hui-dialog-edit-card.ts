...
import { DevconCardConfig, DevconViewConfig } from "../../../../data/devcon";
...
export class HuiDialogEditCard extends LitElement {
  ...
  @property() private _viewConfig!: DevconViewConfig;
  ...
  protected render(): TemplateResult {
    ...
    if (this._cardConfig && this._cardConfig.type) {
      heading = `${this.opp!.localize(
        `ui.panel.devcon.editor.card.${this._cardConfig.type}.name`
      )} ${this.opp!.localize("ui.panel.devcon.editor.edit_card.header")}`;
    } else if (!this._cardConfig) {
      heading = this._viewConfig.title
        ? this.opp!.localize(
            "ui.panel.devcon.editor.edit_card.pick_card_view_title",
            "name",
            `"${this._viewConfig.title}"`
          )
        : this.opp!.localize("ui.panel.devcon.editor.edit_card.pick_card");
    } else {
