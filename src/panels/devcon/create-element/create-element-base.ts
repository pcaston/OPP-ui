import { DevconCardConfig, DevconBadgeConfig } from "../../../data/devcon";
import {
  HuiErrorCard,
...
import {
  ...
  DevconBadge,
  DevconHeaderFooter,
  DevconCardConstructor,
} from "../types";
import { fireEvent } from "../../../common/dom/fire_event";
import { DevconElementConfig, DevconElement } from "../elements/types";
import { DevconRow, DevconRowConfig } from "../entity-rows/types";
...
interface CreateElementConfigTypes {
  card: {
    ...
    element: DevconCard;
    constructor: DevconCardConstructor;
  };
  badge: {
  ...
  element: {
    config: DevconElementConfig;
    element: DevconElement;
    constructor: unknown;
  };
  row: {
    config: DevconRowConfig;
    element: DevconRow;
    constructor: unknown;
  };
  "header-footer": {
    config: DevconHeaderFooterConfig;
    element: DevconHeaderFooter;
    constructor: unknown;
  };
}
...
export const createDevconElement = <T extends keyof CreateElementConfigTypes>(
  tagSuffix: T,
  config: CreateElementConfigTypes[T]["config"],
...
export const getDevconElementClass = async <
