...
import "../../../../components/op-paper-icon-button-next";
...
export class HuiNotificationDrawer extends EventsMixin(
  ...
  static get template() {
    ...
    <div class="container">
      <app-toolbar>
        <div main-title>'ui.notification_drawer.title'</div>
        <op-paper-icon-button-next on-click="_closeDrawer"></paper-icon-button>
      </app-toolbar>
          ...
          <dom-repeat items="[[notifications]]">
            <template>
              <div class="notification">
                <hui-notification-item opp="[[opp]]" notification="[[item]]"></hui-notification-item>
              </div>
            </template>
          </dom-repeat>
        </template>
        <template is="dom-if" if="[[_empty(notifications)]]">
          <div class="empty">'ui.notification_drawer.empty'<div>
        </template>
      </div>
    </div>
    `;
