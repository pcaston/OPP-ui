...
import { OpFormElement, OpFormTimeData, OpFormTimeSchema } from "./op-form";
import { fireEvent } from "../../common/dom/fire_event";

@customElement("op-form-positive_time_period_dict")
export class OpFormTimePeriod extends LitElement implements OpFormElement {
  @property() public schema!: OpFormTimeSchema;
  @property() public data!: OpFormTimeData;
...
declare global {
  interface HTMLElementTagNameMap {
    "op-form-positive_time_period_dict": OpFormTimePeriod;
  }
}
