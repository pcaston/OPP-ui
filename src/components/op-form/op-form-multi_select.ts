...
export class OpFormMultiSelect extends LitElement implements OpFormElement {
  @property() public schema!: OpFormMultiSelectSchema;
  @property() public data!: OpFormMultiSelectData;
...
declare global {
  interface HTMLElementTagNameMap {
    "op-form-multi_select": OpFormMultiSelect;
  }
}
