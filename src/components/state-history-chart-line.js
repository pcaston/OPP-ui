  ...
  drawChart() {
    ...
    deviceStates.forEach((states) => {
      ...
      if (
        ...
        if (hasHeat) {
          addColumn(
            `${this.opp.localize("ui.card.climate.heating", "name", name)}`,
            true,
            true
          );
        ...
        if (hasCool) {
          addColumn(
            `${this.opp.localize("ui.card.climate.cooling", "name", name)}`,
            true,
            true
          );
        ...
        if (hasTargetRange) {
          addColumn(
            `${this.opp.localize(
              ...
              name,
              "mode",
              this.opp.localize("ui.card.climate.high")
            )}`,
            true
          );
          addColumn(
            `${this.opp.localize(
              ...
              name,
              "mode",
              this.opp.localize("ui.card.climate.low")
            )}`,
            true
          );
        } else {
    ...
    const formatTooltipTitle = (items, data) => {
      ...
      return formatDateTimeWithSeconds(date, this.opp.language);
    };
