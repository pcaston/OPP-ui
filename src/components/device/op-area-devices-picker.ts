...
@customElement("op-area-devices-picker")
export class OpAreaDevicesPicker extends SubscribeMixin(LitElement) {
...
declare global {
  interface HTMLElementTagNameMap {
    "op-area-devices-picker": OpAreaDevicesPicker;
  }
}
