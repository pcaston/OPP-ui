...
export abstract class OpDeviceAutomationPicker<
...
> extends LitElement {
  ...
  constructor(
    localizeDeviceAutomation: OpDeviceAutomationPicker<
      T
    >["_localizeDeviceAutomation"],
    fetchDeviceAutomations: OpDeviceAutomationPicker<
      T
    >["_fetchDeviceAutomations"],
    createNoAutomation: OpDeviceAutomationPicker<T>["_createNoAutomation"]
  ) {
    super();
  ...
  private async _updateDeviceInfo() {
    this._automations = this.deviceId
      ? await this._fetchDeviceAutomations(this.opp, this.deviceId)
