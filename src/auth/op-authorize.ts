...
import(
  /* webpackChunkName: "pick-auth-provider" */ "../auth/op-pick-auth-provider"
);
...
class OpAuthorize extends litLocalizeLiteMixin(LitElement) {
...
customElements.define("op-authorize", OpAuthorize);
