import { OppEntityAttributeBase, OppEntity } from "../websocket/lib";
...
export class Entity {
  ...
  public state: string;
  public baseAttributes: OppEntityAttributeBase & { [key: string]: any };
  public attributes: OppEntityAttributeBase & { [key: string]: any };
  public opp?: any;
...
class LightEntity extends Entity {
  public async handleService(domain, service, data) {
    if (!["openpeerpower", this.domain].includes(domain)) {
      return;
    }
...
type LimitedEntity = Pick<OppEntity, "state" | "attributes" | "entity_id">;
