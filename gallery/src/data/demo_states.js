export default {
  ...
  "persistent_notification.notification": {
    ...
    attributes: {
      title: "Welcome Home!",
      message:
        "Here are some resources to get started:\n\n - [Configuring Open Peer Power](https://open-peer-power.io/getting-started/configuration/)\n - [Available integrations](https://open-peer-power.io/integrations/)\n - [Troubleshooting your configuration](https://open-peer-power.io/docs/configuration/troubleshooting/)\n - [Getting help](https://open-peer-power.io/help/)\n\nTo not see this card popup in the future, edit your config in\n`configuration.yaml` and disable the `introduction` integration.",
    },
  ...
  "weather.demo_weather_south": {
    ...
    attributes: {
      ...
      pressure: 1099,
      wind_speed: 0.5,
      attribution: "Powered by Open Peer Power",
      forecast: [
        {
